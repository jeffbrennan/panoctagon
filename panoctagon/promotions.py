...
def setup_promotions():
    ufc = Promotions(promotion_uid=str(uuid.uuid4()), name="UFC", founded_date="1993-11-12")
    one = Promotions(promotion_uid=str(uuid.uuid4()), name="ONE", founded_date="2011-07-14")
